	...
	<div id="main" class="container">
		<div class="row">
			...
			<div id="rightmain" class="col-lg-6 pull-right">
				<!---修改读者信息----->
				<p class="text-center">
					<span id="text">修改读者</span>
				</p>
				<% Reader reader = (Reader)request.getAttribute("reader");%>
				<form class="form-horizontal" action="aus?id=<%=reader.getId()%>" method="post" id="form1">
					<table style="border-collapse: separate; border-spacing: 20px">
						...
						<tr>
							...
							<td>
								<div class="control-group">
									<div class="controls">
										<input type="text" id="inputPassword" value=<%=reader.getReadername() %>
											name="readername">
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="control-group">
									<div class="controls">
										<input type="text" id="inputPassword" value=<%=reader.getPassword() %>
											name="password">
									</div>
								</div>
							</td>
