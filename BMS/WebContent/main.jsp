...
<!----导航条---->
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
						    <li><a href="showadmin">管理员设置</a></li>
	...
	<div id="main" class="container">
			...
			<div id="leftmenu" class="col-lg-3">
				...
				<div class="nav" style="padding-top: 20px;">
					...
					<ul class="nva collapse" id="select">
						...
						<li><a href="showreader">读者信息查询</a></li>
					</ul>
				</div>
				<div class="nav" style="padding-top: 20px;">
		...
		<pre>
		<p style="font-weight: bold;font-size: 20px;">亲爱的读者：</p>
	    <p style="font-size: 16px;">您好，图书馆是大家学习的地方。<br>
  此刻低头，只为他日出人头地。<br>    此刻安静，且待他日侃侃而谈。<br></p>
		</pre>
