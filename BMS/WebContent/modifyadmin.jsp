	...
	<div id="main" class="container">
		<div class="row">
			...
			<div id="rightmain" class="col-lg-6 pull-right">
				<!---修改管理员信息----->
				<p class="text-center">
					<span id="text">修改管理员</span>
				</p>
				<% Admin admin = (Admin)request.getAttribute("admin");%>
				<form class="form-horizontal" action="aus?id=<%=admin.getId()%>" method="post" id="form1">
					<table style="border-collapse: separate; border-spacing: 20px">
						...
						<tr>
							...
							<td>
								<div class="control-group">
									<div class="controls">
										<input type="text" id="inputPassword" value=<%=admin.getAdminname()%>
											name="username">
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="control-group">
									<div class="controls">
										<input type="text" id="inputPassword" value=<%=admin.getPassword() %>
											name="password">
									</div>
								</div>
							</td>
